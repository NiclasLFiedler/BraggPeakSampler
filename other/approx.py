...
def dConstant(lungdef, air, material, water, Pmod):
    ...
    print("(mSM_SA-1)^2:", (mSM_SA-1)**2)
    print("Frac: ", ((mSL_SA-1)*(mSM_SA-mSL_SA)/(mSM_SA-1)**2))
...
# Show the plot
plt.show()
print("Ratio: ", mat["pmma"]["density"]/mat["h2o"]["density"]*mat["pmma"]["Z/A"]/mat["h2o"]["Z/A"]*np.log(2 * 0.511 / mat["pmma"]["I"])/np.log(2 * 0.511 / mat["h2o"]["I"]))
dConstant(mat["lung_def"], mat["air"], mat["h2o"], mat["h2o"], 300)
