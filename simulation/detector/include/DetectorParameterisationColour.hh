...
//
//
/// \file medical/DICOM/include/DetectorParameterisationColour.hh
/// \brief Definition of the DetectorParameterisationColour class
//

#ifndef DetectorParameterisationColour_HH
#define DetectorParameterisationColour_HH
...
class DetectorParameterisationColour : public G4PhantomParameterisation
{
  public:
    typedef std::map<G4String, G4VisAttributes*> ColourMap_t;

    static const G4String fDefaultColorFile;

  public:  // with description
    DetectorParameterisationColour(G4String colorFile = "ColourMap.dat");
    ~DetectorParameterisationColour();
