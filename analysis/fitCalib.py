...
energies_223 = [5.76251, 5.8708, 5.98859, 6.10105, 6.22604, 6.36325, 6.51111, 6.67304, 6.85802, 7.0591, 7.27502, 4.98398, 5.10686, 5.24377, 5.39559, 5.55843, 5.74169, 5.94931, 6.19282, 6.47009, 6.79633, 7.19682, 7.68586, 8.32239, 9.18957, 10.4838, 12.7722, 19.4458, 13.5376]

energies_223_Err = [0.437549, 0.439785, 0.441245, 0.43444, 0.437211, 0.434433, 0.435493, 0.430827, 0.429769, 0.431771, 0.424957, 0.349817, 0.348926, 0.348368, 0.348359, 0.348382, 0.3451, 0.347113, 0.348967, 0.341421, 0.345445, 0.346105, 0.359287, 0.37938, 0.423693, 0.518174, 0.821777, 3.03585, 6.740859]

energies_219 = [5.59688, 5.80769, 5.8718, 5.96124, 6.10725, 6.26295, 6.43208, 6.56667, 6.72854, 7.03419, 7.18189, 4.92829, 5.03123, 5.18937, 5.31206, 5.53226, 5.74969, 5.94248, 6.19561, 6.43622, 6.83463, 7.27007, 7.72352, 8.45055, 9.29967, 10.7145, 13.2168, 21.5441, 8.74111]
 
energies_219_Err = [0.474677, 0.444194, 0.458069, 0.45608, 0.396325, 0.415304, 0.441338, 0.395135, 0.395541, 0.451927, 0.430847, 0.352123, 0.3373, 0.353359, 0.35775, 0.343707, 0.352473, 0.347596, 0.334954, 0.353121, 0.322575, 0.314822, 0.343036, 0.32168, 0.350414, 0.393958, 0.586695, 2.45044, 5.12073]
...
energies_98 = [5.71721, 5.81139, 5.91831, 6.03708, 6.15946, 6.29008, 6.44203, 6.59875, 6.77586, 6.97199, 7.18775, 4.92779, 5.04606, 5.17881, 5.32378, 5.48408, 5.66815, 5.87355, 6.10796, 6.38201, 6.70095, 7.09146, 7.57379, 8.19239, 9.03718, 10.2985, 12.4897, 18.6922, 14.5075]

energies_98_Err = [0.440182, 0.438054, 0.435358, 0.433696, 0.435596, 0.430891, 0.42915, 0.425896, 0.422367, 0.425216, 0.424052, 0.347896, 0.34705, 0.346724, 0.345481, 0.346138, 0.341177, 0.342721, 0.341416, 0.343678, 0.345858, 0.350868, 0.364673, 0.385562, 0.427135, 0.537997, 0.859213, 3.03787, 6.79236]

energies_102 = [5.65881, 5.87199, 5.88555, 6.07751, 6.26771, 6.34185, 6.48244, 6.66879, 6.87966, 7.08572, 7.2943, 4.95027, 5.09443, 5.23245, 5.38334, 5.53264, 5.82028, 6.00686, 6.2874, 6.48608, 6.89532, 7.29705, 7.8044, 8.47707, 9.3438, 10.7927, 13.3269, 21.5576, 9.26734]

energies_102_Err = [0.480719, 0.432872, 0.452431, 0.502123, 0.450599, 0.445464, 0.440628, 0.405816, 0.42797, 0.502134, 0.395131, 0.349347, 0.346537, 0.314775, 0.404005, 0.337198, 0.336015, 0.309681, 0.31839, 0.334189, 0.299707, 0.284167, 0.324247, 0.344733, 0.332124, 0.405034, 0.541424, 2.25746, 4.82299]
...
energyVariance = [
    abs((d1-d2)/2)**2
    for d1, d2 in zip(energies_223, energies_219)
]

densityVariance = [
    (max(abs(n - d1), abs(n - d2))**2)
    for n, d1, d2 in zip(energies, energies_98, energies_102)
]

print(f"Density Variance: {densityVariance}")
...
simulationVariance =[
    o2 + o3 + o4 + o1
    for o1, o2,o3,o4 in zip(energyVariance, listVariance, curoffVariance, densityVariance)
]
...
print()
print(f"Energy Variance: {energyVariance}")
print()
print(f"Simulation Variance: {simulationVariance}")
print()
print(f"Mean ADC Variance: {ADCVariance}")
print()
print(f"Mean Stat ADC Variance: {statADCVariance}")
