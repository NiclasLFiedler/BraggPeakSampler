...
def main():    
    ...
    LY_ej = [3065.69, 2110.67, 2196.13, 948.90, 975.01]
    LY_ej_err = [450.48, 330.26, 362.80, 210.69, 241.14]
    ...
    for index in range(5):
        ...
        print(f"Flat: CH {index} Light yield: {LY_ej[index]} ± {LY_ej_err[index]:.2f} LY_pe: {LY_pe[-1]:.2f} ± {LY_pe_err[-1]:.2f}  LY_ph: {LY_ph[-1]:.2f} ± {LY_ph_err[-1]:.2f}")
